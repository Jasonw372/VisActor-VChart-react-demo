...
export const LineChart = (props: LineChartProps) => {
  ...
  const { colors } = props;
  const parseSpec = useCallback((chartProps: LineChartProps) => {
  ...
  const createOrUpdateChart = useCallback(
    (chartProps: TreemapProps) => {
      if (containerRef.current && !chartRef.current) {
        const chart = new VChart(parseSpec(chartProps), {
        ...
        chartRef.current.updateSpec(parseSpec(chartProps) as any);
        chartRef.current.renderAsync();
